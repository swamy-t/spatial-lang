...
/**
  ...
  */
case class CounterChainOpcode(val w: Int,
                              val numCounters: Int,
  ...
  val counterOpcode =
    Vec(numCounters, CounterOpcode(w, startDelayWidth, endDelayWidth))

  override def cloneType(): this.type = {
    new CounterChainOpcode(w, numCounters, startDelayWidth, endDelayWidth)
      .asInstanceOf[this.type]
  }
}

class CounterChainCore(val w: Int,
                       val numCounters: Int,
  ...
  val io = IO(new Bundle {
    ...
    val config =
      Input(CounterChainOpcode(w, numCounters, startDelayWidth, endDelayWidth))
  })
