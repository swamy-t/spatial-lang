...
class Fringe(
  ...
  val io = IO(new Bundle {
    ...
    //Accel stream IO
    val genericStreamsAccel =
      Flipped(new GenericStreams(streamInsInfo, streamOutsInfo))
  ...
  val regs = Module(
    new RegFile(regWidth, numRegs, numArgIns + 2, numArgOuts + 1))
  ...
  io.argIns := regs.io.argIns
    .drop(2) // Accel argIns: Everything except first argIn
  ...
  regs.io.argOuts.zipWithIndex.foreach {
    case (argOutReg, i) =>
