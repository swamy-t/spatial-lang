...
abstract class AXI4BundleBase(params: AXI4BundleParameters)
    extends GenericParameterizedBundle(params)

abstract class AXI4BundleA(params: AXI4BundleParameters)
    extends AXI4BundleBase(params) {
...
class AXI4BundleW(params: AXI4BundleParameters)
    extends AXI4BundleBase(params) {
  // id ... removed in AXI4
...
class AXI4BundleR(params: AXI4BundleParameters)
    extends AXI4BundleBase(params) {
  val id   = UInt((params.idBits).W)
  val data = UInt((params.dataBits).W)
...
class AXI4BundleB(params: AXI4BundleParameters)
    extends AXI4BundleBase(params) {
  val id   = UInt((params.idBits).W)
  val resp = UInt((params.respBits).W)
}
...
/**
  ...
  */
class AXI4Inlined(params: AXI4BundleParameters)
    extends AXI4BundleBase(params) {
  // aw
